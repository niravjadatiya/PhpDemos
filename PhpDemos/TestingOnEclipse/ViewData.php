...
<html>
    ...
    <body>
        ...
        if ($result->num_rows > 0) {
          ...
          <th id='ID'><a href=ViewData.php?sorting=<?= $sort ?>&Rows=<?= $row_per_page ?>&field=id>ID
          <span class="ID sortIcon"></span>
          </th>

          <th><a href="ViewData.php?sorting=<?= $sort ?>&Rows=<?= $row_per_page ?>&field=firstname">Name
          <span class="firstname sortIcon"></span>
          </th>

          <th><a href='ViewData.php?sorting=<?php echo $sort ?>'&Rows='.$row_per_page."&field=username'>User Name <span class=' username sortIcon'></span></th>
